...
def orden_de_comprar(presupuesto,precio_compra):
	...
	if presupuesto>11 and presupuesto*0.1>11:
		...
		cantidad_gasto=12
	precio_alto=round(precio_compra*1.02,2)
	precio_bajo=round(precio_compra*0.95,2)	

	cantidad_quantily=(cantidad_gasto/precio_bajo)
	cantidad_quantily=round(cantidad_quantily,2)
	print("El presupuesto para la compra es: ",cantidad_quantily)
	cantidad_gasto=cantidad_quantily*precio_bajo
	print(cantidad_gasto)
	print(precio_alto)
	print(precio_bajo)		
	decimales=2
	orden_compra=cliente.order_oco_buy(
				    ...
				    price=str(round(precio_bajo*1.02,2)),                                            
				    stopPrice= str(round(precio_bajo*1.1,2)),                                            
				    stopLimitPrice=str(round(precio_bajo*0.95,2)),                                            
